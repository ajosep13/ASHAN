...
<html>
  ...
  <header>
    ...
    <div class="home_grid_row_2">
        <br><h1 id="vishead">Classes Completed</h1><hr><br>
        <?php
          $userid=$con->query("select * from users where email='".$_SESSION['email']."'");
          $user = mysqli_fetch_assoc($userid);
          $id=$user['userID'];
          $course=$con->query("select courseID from attendeestable where id='".$id."' AND attended='1'");
        ...
        while($row = mysqli_fetch_array($result))
        {
          ...
          echo "<input type='submit' id='Complete' name='Complete' value='Generate certificate' style='width: 150px;background-color:black;color:white;'>";
          echo '</form>';
